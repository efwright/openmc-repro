; ModuleID = 'kernel1-host-x86_64-unknown-linux-gnu.bc'
...
@.__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.region_id = weak constant i8 0
...
@.offloading.entry_name = internal unnamed_addr constant [45 x i8] c"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6\00", section ".llvm.rodata.offloading", align 1
@.offloading.entry.__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6 = weak constant %struct.__tgt_offload_entry { i64 0, i16 1, i16 1, i32 0, ptr @.__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.region_id, ptr @.offloading.entry_name, i64 0, i64 0, ptr null }, section "llvm_offload_entries", align 8

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef float @_Z7kernel1Pfi(ptr noundef %A, i32 noundef %n) #0 {
entry:
  ...
  %37 = call i32 @__tgt_target_kernel(ptr @4, i64 -1, i32 0, i32 0, ptr @.__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.region_id, ptr %kernel_args)
  %38 = icmp ne i32 %37, 0
  br i1 %38, label %omp_offload.failed, label %omp_offload.cont

omp_offload.failed:                               ; preds = %entry
  call void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6(i64 %1, ptr %val, ptr %2) #2
...
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6(i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #1 {
entry:
  ...
  %3 = load ptr, ptr %A.addr, align 8
  call void (ptr, i32, ptr, ...) @__kmpc_fork_teams(ptr @4, i32 3, ptr @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined, i64 %2, ptr %0, ptr %3)
  ret void
}

; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #1 {
entry:
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @4, i32 5, ptr @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined.omp_outlined, i64 %15, i64 %17, i64 %19, ptr %val1, ptr %20)
...
omp.precond.end:                                  ; preds = %omp.loop.exit, %entry
  ...
  %28 = call i32 @__kmpc_reduce_nowait(ptr @3, i32 %27, i32 1, i64 8, ptr %.omp.reduction.red_list, ptr @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined.omp.reduction.reduction_func, ptr @.gomp_critical_user_.reduction.var)
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined.omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %.previous.lb., i64 noundef %.previous.ub., i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #1 {
entry:
  %.global_tid..addr = alloca ptr, align 8
  %.bound_tid..addr = alloca ptr, align 8
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %27 = call i32 @__kmpc_reduce_nowait(ptr @3, i32 %26, i32 1, i64 8, ptr %.omp.reduction.red_list, ptr @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined.omp_outlined.omp.reduction.reduction_func, ptr @.gomp_critical_user_.reduction.var)
...
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined.omp_outlined.omp.reduction.reduction_func(ptr noundef %0, ptr noundef %1) #3 {
entry:
...
; Function Attrs: noinline norecurse uwtable
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6.omp_outlined.omp.reduction.reduction_func(ptr noundef %0, ptr noundef %1) #3 {
entry:
  %.addr = alloca ptr, align 8
  %.addr1 = alloca ptr, align 8
  store ptr %0, ptr %.addr, align 8
