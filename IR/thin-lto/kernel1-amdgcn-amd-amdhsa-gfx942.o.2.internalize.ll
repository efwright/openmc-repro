; ModuleID = 'kernel1-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
source_filename = "kernel1.cpp"
...
@anon.a9ed9815896cf6404667e416dfa6df1a.0 = private unnamed_addr constant [23 x i8] c";unknown;unknown;0;0;;\00", align 1
@anon.a9ed9815896cf6404667e416dfa6df1a.1 = private unnamed_addr addrspace(1) constant %struct.ident_t { i32 0, i32 2, i32 0, i32 22, ptr @anon.a9ed9815896cf6404667e416dfa6df1a.0 }, align 8
...
@anon.a9ed9815896cf6404667e416dfa6df1a.2 = private unnamed_addr addrspace(1) constant %struct.ident_t { i32 0, i32 2050, i32 0, i32 22, ptr @anon.a9ed9815896cf6404667e416dfa6df1a.0 }, align 8
@anon.a9ed9815896cf6404667e416dfa6df1a.3 = private unnamed_addr addrspace(1) constant %struct.ident_t { i32 0, i32 514, i32 0, i32 22, ptr @anon.a9ed9815896cf6404667e416dfa6df1a.0 }, align 8
@__openmp_nvptx_data_transfer_temporary_storage = weak addrspace(3) global [64 x i32] undef
@anon.a9ed9815896cf6404667e416dfa6df1a.4 = private unnamed_addr addrspace(1) constant %struct.ident_t { i32 0, i32 66, i32 0, i32 22, ptr @anon.a9ed9815896cf6404667e416dfa6df1a.0 }, align 8

; Function Attrs: convergent mustprogress noinline norecurse nounwind optnone
define weak_odr protected amdgpu_kernel void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6(ptr noalias noundef %dyn_ptr, i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #0 {
entry:
  ...
  %1 = call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_kernel_environment to ptr), ptr %dyn_ptr)
  %exec_user_code = icmp eq i32 %1, -1
  br i1 %exec_user_code, label %user_code.entry, label %worker.exit

user_code.entry:                                  ; preds = %entry
  %2 = call i32 @__kmpc_global_thread_num(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.1 to ptr))
  ...
  call void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined(ptr %.threadid_temp..ascast, ptr %.zero.addr.ascast, i64 %4, ptr %0, ptr %5) #2
...
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #1 {
entry:
...
omp.precond.then:                                 ; preds = %entry
  ...
  call void @__kmpc_distribute_static_init_4(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.2 to ptr), i32 %6, i32 91, ptr %.omp.is_last.ascast, ptr %.omp.comb.lb.ascast, ptr %.omp.comb.ub.ascast, ptr %.omp.stride.ascast, i32 1, i32 %nvptx_num_threads)
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  call void @__kmpc_parallel_51(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.1 to ptr), i32 %30, i32 1, i32 -1, i32 -1, ptr @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined, ptr null, ptr %captured_vars_addrs.ascast, i64 5)
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.2 to ptr), i32 %43)
...
; Function Attrs: convergent noinline norecurse nounwind optnone
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %.previous.lb., i64 noundef %.previous.ub., i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #1 {
entry:
  %.global_tid..addr = alloca ptr, align 8, addrspace(5)
  %.bound_tid..addr = alloca ptr, align 8, addrspace(5)
...
omp.precond.then:                                 ; preds = %entry
  ...
  call void @__kmpc_for_static_init_4(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.3 to ptr), i32 %8, i32 33, ptr %.omp.is_last.ascast, ptr %.omp.lb.ascast, ptr %.omp.ub.ascast, ptr %.omp.stride.ascast, i32 1, i32 1)
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  call void @__kmpc_for_static_fini(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.3 to ptr), i32 %20)
  %21 = getelementptr inbounds [1 x ptr], ptr %.omp.reduction.red_list.ascast, i64 0, i64 0
  store ptr %val4.ascast, ptr %21, align 8
  %22 = call i32 @__kmpc_nvptx_parallel_reduce_nowait_v2(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.1 to ptr), i64 4, ptr %.omp.reduction.red_list.ascast, ptr @_omp_reduction_shuffle_and_reduce_func, ptr @_omp_reduction_inter_warp_copy_func)
  %23 = icmp eq i32 %22, 1
...
define internal void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined_omp$reduction$reduction_func"(ptr noundef %0, ptr noundef %1) #3 {
entry:
...
then:                                             ; preds = %entry
  call void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined_omp$reduction$reduction_func"(ptr %4, ptr %.omp.reduction.remote_reduce_list.ascast) #2
  br label %ifcont
...
entry:
  ...
  %omp_global_thread_num = call i32 @__kmpc_global_thread_num(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.1 to ptr))
  call void @__kmpc_barrier(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.4 to ptr), i32 %omp_global_thread_num)
...
ifcont:                                           ; preds = %else, %then
  %omp_global_thread_num2 = call i32 @__kmpc_global_thread_num(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.1 to ptr))
  call void @__kmpc_barrier(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.4 to ptr), i32 %omp_global_thread_num2)
...
; Function Attrs: convergent noinline norecurse nounwind
define internal void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr noundef %0, ptr noundef %1) #3 {
entry:
  %.addr = alloca ptr, align 8, addrspace(5)
  %.addr1 = alloca ptr, align 8, addrspace(5)
  %.addr.ascast = addrspacecast ptr addrspace(5) %.addr to ptr
...
then:                                             ; preds = %entry
  call void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr %4, ptr %.omp.reduction.remote_reduce_list.ascast) #2
  br label %ifcont
...
entry:
  ...
  call void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr %.omp.reduction.red_list.ascast, ptr %8) #2
  ret void
}
...
entry:
  ...
  store ptr %7, ptr %5, align 8
  %8 = load ptr, ptr %.addr2.ascast, align 8
  call void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr %8, ptr %.omp.reduction.red_list.ascast) #2
  ret void
}
...
!0 = !{i32 0, i32 82, i32 48991881, !"_Z7kernel1Pfi", i32 6, i32 0, i32 0}
