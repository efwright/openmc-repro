; ModuleID = 'kernel1-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  call void @__kmpc_parallel_51(ptr addrspacecast (ptr addrspace(1) @1 to ptr), i32 %30, i32 1, i32 -1, i32 -1, ptr @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined, ptr null, ptr %captured_vars_addrs.ascast, i64 5)
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %22 = call i32 @__kmpc_nvptx_parallel_reduce_nowait_v2(ptr addrspacecast (ptr addrspace(1) @1 to ptr), i64 4, ptr %.omp.reduction.red_list.ascast, ptr @_omp_reduction_shuffle_and_reduce_func, ptr @_omp_reduction_inter_warp_copy_func)
  %23 = icmp eq i32 %22, 1
...
!llvm.ident = !{!7, !8, !8, !8, !8, !8, !8, !8, !8}
!opencl.ocl.version = !{!9, !9, !9, !9, !9, !9, !9, !9}
