; ModuleID = 'kernel1-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define weak_odr protected amdgpu_kernel void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6(ptr noalias noundef %dyn_ptr, i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) local_unnamed_addr #0 {
entry:
...
user_code.entry:                                  ; preds = %entry
  ...
  call fastcc void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined(ptr %.threadid_temp..ascast, ptr %.zero.addr.ascast, i64 %4, ptr %0, ptr %5) #12
...
define internal fastcc void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) unnamed_addr #2 {
entry:
...
; Function Attrs: convergent noinline norecurse nounwind optnone
define internal void @__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %.previous.lb., i64 noundef %.previous.ub., i64 noundef %n, ptr noundef nonnull align 4 dereferenceable(4) %val, ptr noundef %A) #2 {
entry:
  %.global_tid..addr = alloca ptr, align 8, addrspace(5)
  %.bound_tid..addr = alloca ptr, align 8, addrspace(5)
...
define internal fastcc void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined_omp$reduction$reduction_func"(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) unnamed_addr #4 {
entry:
...
then:                                             ; preds = %entry
  ...
  call fastcc void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp_outlined_omp$reduction$reduction_func"(ptr nonnull %0, ptr %.omp.reduction.remote_reduce_list.ascast) #13
  br label %ifcont
...
entry:
  ...
  %omp_global_thread_num2 = tail call i32 @__kmpc_global_thread_num(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.1 to ptr)) #12
  tail call void @__kmpc_barrier(ptr addrspacecast (ptr addrspace(1) @anon.a9ed9815896cf6404667e416dfa6df1a.4 to ptr), i32 %omp_global_thread_num2) #12
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define internal fastcc void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) unnamed_addr #4 {
entry:
...
then:                                             ; preds = %entry
  %.omp.reduction.remote_reduce_list.ascast = addrspacecast ptr addrspace(5) %.omp.reduction.remote_reduce_list to ptr
  call fastcc void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr nonnull %0, ptr %.omp.reduction.remote_reduce_list.ascast) #13
  br label %ifcont
...
entry:
  ...
  call fastcc void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr %.omp.reduction.red_list.ascast, ptr %2) #13
  ret void
}
...
entry:
  ...
  %4 = getelementptr inbounds %struct._globalized_locals_ty, ptr %0, i64 %3
  store ptr %4, ptr addrspace(5) %.omp.reduction.red_list, align 8
  call fastcc void @"__omp_offloading_52_2eb8e89__Z7kernel1Pfi_l6_omp_outlined_omp$reduction$reduction_func"(ptr %2, ptr %.omp.reduction.red_list.ascast) #13
  ret void
}
